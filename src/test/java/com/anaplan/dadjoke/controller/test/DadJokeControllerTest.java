package com.uday.dadjoke.controller.test;

import com.uday.dadjoke.DadjokeApplication;
...
@SpringBootTest(webEnvironment=SpringBootTest.WebEnvironment.DEFINED_PORT, classes={ DadjokeApplication.class })
public class DadJokeControllerTest {
    ...
    public void setUp() throws Exception {
        this.base = new URL("http://localhost:" + port + "/dadjoke");
        template = new TestRestTemplate().withBasicAuth("ap", "apapp!");
    }

    @Test
    public void shouldGetDadJoke() {
        ResponseEntity<String> response = template.getForEntity(base.toString(), String.class);
        assertThat(response.getStatusCode(), equalTo(HttpStatus.OK));
    }

    @Test
    public void getDadJokeShouldSendResponseHeaders() {
        ResponseEntity<String> response = template.getForEntity(base.toString(), String.class);
        assertThat(response.getStatusCode(), equalTo(HttpStatus.OK));
